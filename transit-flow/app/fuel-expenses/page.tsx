...
export default function FuelExpensesPage() {
  ...
  function fetchAll() {
    ...
    setError(null);
    Promise.all([
      apiFetch<FuelLog[]>("/fuel-logs", { params: { search: search || undefined } }),
      apiFetch<Expense[]>("/expenses", { params: { search: search || undefined } }),
            ...
            <tfoot>
              <TableRow>
                ...
                <TableCell colSpan={2} className="font-semibold text-foreground">
                  {totalOperationalCost !== null ? `₹${totalOperationalCost.toLocaleString()}` : "--"}
                </TableCell>
              </TableRow>
            </tfoot>
          </Table>
